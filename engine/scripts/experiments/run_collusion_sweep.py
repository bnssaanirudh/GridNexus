...
def run_collusion_sweep():
    ...
    for seed in seeds:
        ...
        for n_agents in agent_counts:
            ...
            for fraction in collusion_fractions:
                ...
                colluders = random.sample([a for a in attack_agents if a['type'] == 'sell'], min(n_colluders, len([a for a in attack_agents if a['type'] == 'sell'])))
    ...
    print("Sweep complete. Results saved to results/collusion_sweep.csv")
